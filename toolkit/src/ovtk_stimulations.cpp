...
boolean OpenViBEToolkit::initializeStimulationList(const IKernelContext& rKernelContext)
{
	...
	l_rTypeManager.registerEnumerationEntry(OV_TypeId_Stimulation, "OVTK_StimulationId_Reset", OVTK_StimulationId_Reset);
	...
	l_rTypeManager.registerEnumerationEntry(OV_TypeId_Stimulation, "OVTK_GDF_Artifact_Failing_Electrode", OVTK_GDF_Artifact_Failing_Electrode0x00008004);
